...
import { LandingInstallBanner } from "@/components/pwa/landing-install-banner";
import { BRAND_CONFIG } from "@/config/brand";

export const metadata: Metadata = {
  title: `${BRAND_CONFIG.name} - Progressive Web App`,
  description: `${BRAND_CONFIG.description} - Install as a native app. Works offline with sync. No app store needed.`,
  keywords: ["church management", "progressive web app", "PWA", "offline", "church app", "member management", "attendance tracking"],
  openGraph: {
    title: `${BRAND_CONFIG.name} - Install Church Management App`,
    description: `${BRAND_CONFIG.description} - Progressive Web App with offline capabilities and native app experience.`,
    type: "website",
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: `${BRAND_CONFIG.name} App Icon`,
      },
    ],
  },
  twitter: {
    ...
    title: `${BRAND_CONFIG.name} - Progressive Web App`,
    description: `Install ${BRAND_CONFIG.name} directly from your browser. Works offline, syncs online.`,
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="flex flex-col items-center gap-2">
              <p className="text-sm text-accent-secondary font-semibold" 
                 aria-live="polite">
                {BRAND_CONFIG.webPlatform}
              </p>
              <div className="flex items-center gap-2 text-xs text-gray-300">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3.75 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" />
                </svg>
                <span>Install as app • Works offline</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="mt-20 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-left">
              <div>
                ...
                <p className="text-gray-600">Members check themselves in with a simple tap, reducing volunteer workload. Works even when your internet is spotty.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Real-Time Sync</h3>
                <p className="text-gray-600">Offline check-ins sync automatically when connected. Live attendance dashboard with instant reporting.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">App Shortcut</h3>
                <p className="text-gray-600">Add check-in shortcut to home screen for one-tap Sunday service attendance. No app store required.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section aria-labelledby="pwa-platform-title">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="mb-20">
            <p className="text-lg font-medium text-accent-secondary mb-4 tracking-tight">Progressive Web App</p>
            <h2 id="pwa-platform-title" className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter mb-6">
              Install {BRAND_CONFIG.name}
            </h2>
            <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 font-medium max-w-4xl mx-auto leading-relaxed tracking-tight">
              App-like experience. No app store needed. Works offline with sync.
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-6 items-center justify-center">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl px-6 py-4 flex items-center gap-3 border border-white/10 hover:border-white/20 transition-all duration-300">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-gray-300">iOS Safari</span>
                    </div>
                    <div className="text-white text-sm">
                      <div className="font-medium">Share → Add to Home Screen</div>
                      <div className="text-xs text-gray-400">No App Store required</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl px-6 py-4 flex items-center gap-3 border border-white/10 hover:border-white/20 transition-all duration-300">
                    ...
                    <div className="text-white text-sm">
                      <div className="font-medium">Menu → Install App</div>
                      <div className="text-xs text-gray-400">Chrome, Edge, Samsung</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 text-left mb-12">
              <div>
                ...
                <p className="text-gray-300">Continue checking in members, viewing schedules, and accessing data even without internet. Syncs automatically when back online.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">App-Like Experience</h3>
                <p className="text-gray-300">Home screen icon, full screen mode, and native app feel without the app store download or updates.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white mb-3">Instant Loading</h3>
                <p className="text-gray-300">Pages load instantly with intelligent caching. Background sync keeps your data fresh and secure.</p>
              </div>
            </div>
            
            <div className="bg-gradient-to-r from-accent/20 to-accent-secondary/20 rounded-2xl p-6 border border-accent/20 mb-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                <svg className="w-6 h-6 text-accent-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <h3 className="text-lg font-semibold text-white">Available Now</h3>
              </div>
              <p className="text-gray-300 text-center">Progressive Web App technology means no waiting for app store approval or device compatibility issues. Install directly from your browser.</p>
            </div>
          </div>
        </div>
      </section>
